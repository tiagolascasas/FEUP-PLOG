pos(nw, nw, 0). pos(nw, n, 0). pos(nw, ne, g).   	pos( n, nw, 0). pos( n, n, 0). pos( n, ne, 0).   	pos(ne, nw, g). pos(ne, n, 0). pos(ne, ne, 0).
pos(nw,  w, 0). pos(nw, c, 0). pos(nw, e,  0).   	pos( n,  w, 0). pos( n, c, 0). pos( n,  e, 0).   	pos(ne,  w, 0). pos(ne, c, 0). pos(ne,  e, 0).
pos(nw, sw, 0). pos(nw, s, 0). pos(nw, se, 0).   	pos( n, sw, 0). pos( n, s, 0). pos( n, se, 0).   	pos(ne, sw, 0). pos(ne, s, 0). pos(ne, se, b).

pos( w, nw, 0). pos( w, n, b). pos( w, ne, 0).   	pos( c, nw, b). pos( c, n, 0). pos( c, ne, 0).   	pos( e, nw, 0). pos( e, n, 0). pos( e, ne, 0).
...
pos(sw,  w, 0). pos(sw, c, 0). pos(sw, e,  0).   	pos( s,  w, 0). pos( s, c, 0). pos( s,  e, 0).   	pos(se, w, g).  pos(se, c, 0). pos(se,  e, 0).
